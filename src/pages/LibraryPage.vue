    ...
    <main class="mx-auto max-w-10xl px-4 sm:px-6 lg:px-8">
        <section aria-labelledby="products-heading" class="pb-24 pt-6">
            <div class="flex items-baseline justify-between border-b-2 border-gray-200 py-6">
                <h3 class="text-2xl font-bold tracking-tight text-gray-900">Danh sách các loại sách</h3>
                ...
                <div class="pb-6 pt-4 hidden lg:flex w-1/2">
                    <div class="border-2 w-full flex mx-auto rounded-lg border-gray-500">
                        <input type="text" class="w-full p-3 focus:outline-none rounded-lg"
                            placeholder="Tìm tên sách ... " v-model="searchQuery">
                        <button class="bg-rose-600 w-1/5 h-100 hover:bg-rose-600 " @click="handleSearch"><i
                                class="fas fa-search text-white text-xl"></i></button>
                    </div>
                </div>
            </div>
            <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                <form class="lg:block py-16 sm:py-6 mt-6 hidden lg:block">
                    <div v-for="section in filters" :key="section.id" class="border-b border-gray-200 py-6">
